...
class InlineEditing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Editeur inline', 'elementor-osmova-plugin' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'elementor-osmova-plugin' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'elementor-osmova-plugin' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Description', 'elementor-osmova-plugin' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'elementor-osmova-plugin' ),
			]
		);
